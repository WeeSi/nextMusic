      ...
      <div className="mx-auto container py-20 px-6">
          <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                      ...
                      <div>
                          <div className="flex items-center justify-between text-gray-800">
                              ...
                              <div className="w-8 h-8 rounded-full bg-gray-800 text-white flex items-center justify-center">
                                  <svg xmlns="http://www.w3.org/2000/svg"  width={40} height={25} viewBox="0 0 20 22" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
              ...
              <div className="rounded">
                  ...
                  <div className="w-full h-64 flex flex-col justify-between dark:bg-gray-600 bg-white dark:border-gray-700 rounded-lg border border-gray-400 mb-6 py-5 px-4">
                      <div>
