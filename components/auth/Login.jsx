  ...
  return (
    ...
    >
      ...
      <div>
        <button
          onClick={() => send()}
          className="w-full text-center p-3 bg-blue-500 rounded-lg text-white"
        >
          Login now
        </button>
      </div>
      <div className="flex space-x-2 pt-8 w-full">
        <h2 className="flex w-fit">Pas encore inscrit ?</h2>
        <NmBtn label="S'inscrire !" variant="text" action={setMode} />
      </div>
    </div>
  );
};
